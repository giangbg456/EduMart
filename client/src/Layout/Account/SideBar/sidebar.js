...
const activeStyle = 'flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-grey-1 bg-grey-1'
const notActiveStyle  = 'flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-grey-1'
...
function SideBar() {
  ...
  return (
    <aside className="p-2 pr-0 w-64 h-screen" aria-label="Sidebar">
      <div className="h-full overflow-hidden py-4 px-3 rounded-2xl bg-white">
        <Link to={'/'}>
          <h1 className="text-center text-lg font-semibold pb-6 border-b border-default">EduMart</h1>
        </Link>
        <ul className="space-y-2 h-full mt-5">
            <li>
            ...
            {/* <li>
              <NavLink to="/account/teachers" className={({isActive}) => isActive ? activeStyle : notActiveStyle }>
                  ...
                  <span className="flex-1 ml-3 whitespace-nowrap">Teachers</span>
              </NavLink>
            </li> */}
            {/* <li>
            ...
            <li className="absolute bottom-2">
              <button href="#" className="flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-grey-1" onClick={() => { dispatch(actions.logout()) }}>
